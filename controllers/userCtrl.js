    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                generalqr: findUser.generalqr,
                duplicateqr: findUser.duplicateqr,
                specificqr: findUser.specificqr,
                qrdatamaster: findUser.qrdatamaster,
                cuttingroll: findUser.cuttingroll,
                namechangeqr:findUser.namechangeqr,
                grprint: findUser.grprint,
                availablestock:findUser.availablestock,
                locationchange: findUser.locationchange,
                addquality:findUser.addquality,
